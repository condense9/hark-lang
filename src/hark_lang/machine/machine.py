...
from ..exceptions import HarkError, UserResolvableError, UnexpectedError
...
class TlMachine:
    """Virtual Machine to execute Hark bytecode.
    ...
    def _(self, i: Call):
        ...
        if isinstance(fn, mt.TlFunctionPtr):
            ...
            result = mt.to_hark_type(py_result)
